...
{{#if subagent_delegation_note}}
{{subagent_delegation_note}}
...
{{#if available_agents}}
You may only delegate to the profiles listed below. Pass the profile id via the `profile` argument of `spawn_agent`.
