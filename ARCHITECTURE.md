...
| `delegation` | Правила делегирования: `allowed` профили и `max_depth` (1–5); без блока — спавн только агентов без профиля |
...
- **Проверка прав и глубины** — наличие права `spawn_agent`, для профилированного спавна — явное вхождение в `delegation.allowed`, лимиты `delegation.max_depth` и глобального `agent.nested_sub_agents` (`enabled`, `max_depth` 1–5, `max_concurrent` 1–32, по умолчанию 16).
